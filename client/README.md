...
- Version pin: `Talaria\SilverStripe\Config.browserSdkVersion` (default `0.1.5`)

CMS injects `inlineStylesheet: true` (auth-gated admin CSS). Frontend defaults to `false`. Override with `browserInlineStylesheet` in YAML.
